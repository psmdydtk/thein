      ...
      <form>
         <H3>식당 정보</H3>
          <c:forEach items="${list }" var="list">
          		<form id="" action="reservation.do" method="POST">
						...
						<tr>
							...
							<input type="hidden" id="raser_user_id" value="${sessionScope.id}">
							<input type="hidden" id="raser_shop_date" value="<%=datepick %>">
							<input type="hidden" id="raser_shop_id" value="${list.shop_id }">
